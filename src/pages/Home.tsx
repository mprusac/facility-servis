...
const Home = () => {
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      {/* Achievement Banner */}
      {showBanner && (
        <div className={`fixed top-20 left-1/2 -translate-x-1/2 z-50 transition-all duration-500 ${isExiting ? 'opacity-0 translate-y-[-20px]' : 'opacity-100 translate-y-0 animate-fade-in'}`}>
